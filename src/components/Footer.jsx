...
export default function Footer() {
  ...
  return (
    <div className="border-t border-base-300 bg-base-200">
      <footer className="max-w-6xl mx-auto px-4 py-10 flex flex-col sm:flex-row gap-10 text-base-content items-center sm:items-start justify-center sm:justify-between footer">
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left max-w-xs">
          ...
          <a href="https://maps.app.goo.gl/rgwaKGch5jPKVe286" className="hover:text-primary flex gap-1 max-w-60 mt-5 justify-center sm:justify-start">
            <FaLocationDot />
            Farg'ona viloyati, Rishton tumani Farg'ona yo'li ko'chasi 1-son
          </a>
        </div>

        <nav className="flex flex-col gap-1 sm:items-start items-center">
